...
public class Popup0 : TestUnit
{
    ...
    public override void OnCreate(View root)
    {
        ...
        var style = (PopupStyle)Tizen.NUI.Components.StyleManager.Instance.GetComponentStyle(typeof(Popup));
    ...
    public override string PassCondition => "Click Left or Right button in Popup1\n"
                                          + "* Popup1 disappear and Popup0 shows the choosen text (Left or Right)\n\n"
                                          + "Click Left or Right button in Popup0\n"
                                          + "* Popup0 disappear";
}
